...
export class RecetasService {
  ...
  obtenerComentariosReceta(id: string): { username: string; comment: string; }[] {
    const comentarios = localStorage.getItem(`comentarios_${id}`);
    if (comentarios) {
  ...
  guardarComentarioReceta(id: string, comentarios: { username: string; comment: string; }[]) {
